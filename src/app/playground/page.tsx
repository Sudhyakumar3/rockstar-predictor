...
const Playground = () => {
  ...
  const buttonVariants = {
    hover: {
      ...
      transition: {
        duration: 0.3,
        yoyo: 3 // Rock back and forth 3 times
      }
    }
  };

  return (
    <div className="relative flex flex-col items-center min-h-screen bg-black text-white px-4">
      <Navbar />

      {/* Main Content Box */}
      <motion.div
        className="absolute top-[20%] z-10 w-full max-w-3xl bg-black bg-opacity-70 p-8 rounded-lg shadow-lg"
      ...
      >
        ...
        {/* Theme Selection */}
        <motion.div
          className="bg-gray-800 bg-opacity-90 p-6 mt-6 rounded-lg shadow-md w-full"
          variants={itemVariants}
        >
        ...
        {/* Keywords Input */}
        <motion.div
          className="bg-gray-800 p-6 mt-4 rounded-lg shadow-md w-full"
          variants={itemVariants}
        >
